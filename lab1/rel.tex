...
\begin{document}
	...
	Por aplicação da Lei de Ohm e fazendo as respetivas substituições, obtém-se finalmente a expressão para calcular os elementos da matriz dos coeficientes de resistência para o sistema de condutores:
	...
	\begin{align*}
		[R] = \frac{1}{2\pi\sigma l} [K], onde [K] = \ln\left(\frac{r'_{ij} }{r_{ij} }\right) 
	\end{align*}
	
	depende apenas raio dos condutores cilíndricos e das distâncias destes entre si e ao plano condutor.
